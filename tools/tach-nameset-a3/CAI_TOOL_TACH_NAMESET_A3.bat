...
chcp 65001 >nul
title Cai DHL Nameset Layout cho CorelDRAW - V7.2
...
echo.
echo DA CAI XONG DHL NAMESET LAYOUT - V7.2
echo Da them SET TRANG IN / LAY KHO TRANG va doi ten tool.
...
:UI_FAIL
echo.
echo TOOL DA CAI NHUNG KHONG GHI DUOC GIAO DIEN V7.2.
