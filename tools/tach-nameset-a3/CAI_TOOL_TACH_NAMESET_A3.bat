...
chcp 65001 >nul
title Cai tool Tach Nameset A3 cho CorelDRAW - V6.9
...
echo.
echo DA CAI XONG TOOL TACH NAMESET A3 - BAN V6.9
echo Giao dien da chuyen sang English va sua loi chu chong len nhau.
...
:UI_FAIL
echo.
echo TOOL DA CAI NHUNG KHONG GHI DUOC GIAO DIEN V6.9.
