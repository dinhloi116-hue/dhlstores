  ...
  async function createDirect(){
    ...
    try{
      ...
      const ok=confirm(
        ...
        `Tool lấy cột A Đường dẫn/Alias làm SKU gốc; SKU từng size = Alias + Size. Tool kiểm tra trùng trước khi tạo, đưa ảnh nguồn lên Sapo và ghi tồn từng size.\n`+
  ...
  function mount(){
    ...
    box.innerHTML=`
      ...
      <div class="single-product-add-steps">
        ...
        3) Kiểm tra đủ màu/size → <b>ĐĂNG 1 SP LÊN SAPO</b>. SKU Sapo = Đường dẫn/Alias + Size.
      </div>
