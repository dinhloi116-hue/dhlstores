(() => {
  ...
  function mountCatalogShell() {
    ...
    section.innerHTML = `
      ...
      <span style="display:block;margin:6px 0 10px">Quét cả danh mục trong 1 lượt bằng POPUP THẬT: tự mở từng sản phẩm → đọc đủ màu/size/tồn → đóng → sang sản phẩm tiếp theo. KHÔNG lấy SKU cũ. Cột A Đường dẫn/Alias là mã gốc; SKU phân loại = Alias + Size.</span>
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        <button id="scanCatalogSource" class="primary" style="flex:1;min-width:145px">QUÉT TẤT CẢ SP MỚI BẰNG POPUP</button>
