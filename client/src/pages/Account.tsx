...
export default function Account() {
  ...
  const [withdrawalDraft, setWithdrawalDraft] = useState({ amount: "", bankCode: "", accountNumber: "", accountHolder: "", note: "" });
  ...
  const createWalletWithdrawal = trpc.store.createWalletWithdrawal.useMutation({
    onSuccess: async () => {
      setWithdrawalDraft({ amount: "", bankCode: "", accountNumber: "", accountHolder: "", note: "" });
