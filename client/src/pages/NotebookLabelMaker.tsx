...
function drawLabel(row: LabelRow, template: LabelTemplate, width = 1000, height = 540) {
  ...
  const exportPdf = async () => {
    ...
    try {
      ...
      rows.forEach((row, index) => {
        ...
        pdf.addImage(drawLabel(row, template), "PNG", x, y, cellW, cellH, undefined, "FAST");
      });
