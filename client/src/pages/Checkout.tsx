...
import { ArrowLeft, CheckCircle2, Download, MapPin, Plus, QrCode, ShieldCheck, ShoppingBag, WalletCards } from "lucide-react";
        ...
        <main className="max-w-2xl mx-auto px-4 sm:px-6 py-10">
          <section className="bg-white border border-slate-200 shadow-sm rounded-2xl overflow-hidden">
            <div className="px-6 py-5 bg-slate-900 text-white">
              <p className="text-[11px] tracking-[0.18em] font-bold uppercase text-amber-300">DHL Stores · {isWalletPayment ? "Ví số dư" : isPhysicalPayment ? "Techcombank QR" : "VietinBank · SePay QR"}</p>
